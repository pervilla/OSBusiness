...
Private Sub pasa_cabeza()
   grid_fac.TextMatrix(0, 0) = "Descripci�n"
...
If i_codcli.Visible = False Then i_codcli.Text = ""
  ...
  If CONS_llave.EOF Then
    MsgBox "Cliente No Tiene Gu�as a Consignaci�n.O Canje", 48, Pub_Titulo
...
If Check1.Value = 1 Then
   grid_fac.Clear
   pasa_cabeza
   MsgBox "Ingresar el numero de Kardex , con el que se realiz� el Ingreso , Si no conoce el nombre lo puede averiguar en la Opci�n Herramientas-Consultas-Kardex"
   i_numser.SetFocus
Else
   cancela_todo
End If
...
'Close #1
'*** Imprime la Transacci�n a un Archivo
...
'   If LK_CODTRA = 2728 And LK_EMP = "PLA" Then
'      PLAZA_FLAG_MANUAL = " "
'      plaza_tasa1 = InputBox("Ingrese (%)Tasa  Compensatorio : D�as: " & WK_DIASV, "Tasa de Interes", "0")
'      If plaza_tasa1 = "" Then GoTo pasa_tasa
'      plaza_tasa2 = InputBox("Ingrese (%)Tasa  Moratoria     : D�as: " & WK_DIASV, "Tasa de Interes", "0")
...
Else
     MsgBox "Transacci�n NO corresponde a est� M�dulo ", 48, Pub_Titulo
     Azul TRANS, TRANS
     Exit Sub
End If
