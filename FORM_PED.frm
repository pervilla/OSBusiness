...
Begin VB.Form FORM_PED 
   ...
   Begin VB.Frame fraListar 
      ...
      Begin VB.Label Label8 
         Caption         =   "Un Momento... procesando informaci�n."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
If Not temp_llave.EOF Then
   ...
   con_llave.Close
   MsgBox "Existe Nro. de Docuemnto, el sistema gener� el correlativo,  intente grabar nuevamente...", 48, Pub_Titulo
   Exit Sub
End If
End If
