...
cmdEliminar.Enabled = False
cmdEliminar.Caption = "&Eliminaci�n"
...
If Left(cmdEliminar.Caption, 12) = "&Eliminaci�n" Then
    WSELE = ""
...
Exit Sub
Error_fatal:
    msg = "Se ha producido un error " & "al abrir la conexi�n:" & Err & " - " & Error & vbCr
...
grid1.TextMatrix(0, 1) = " Descripci�n "
