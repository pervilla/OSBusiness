...
If Not IsDate(fecha1.Caption) Then
 MsgBox "Verificar Configuraci�n Regional .. no procde las Fechas N�1", 48, Pub_Titulo
 Exit Sub
End If
...
Case 2
    ...
    If Trim(cmbdivi.Text) = "" Then
      MsgBox "Seleccionar un Divisi�n", 48, Pub_Titulo
      cmbdivi.SetFocus
