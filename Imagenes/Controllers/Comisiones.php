...
class Comisiones extends BaseController {
    ...
    public function index() {
        /*     $this->Facart_model = new FacartModel();
          $comisiones = $this->Facart_model->get_comisiones('5', '2021');
          $this->Facart3_model = new Server03Model();
          $comisiones3 = $this->Facart3_model->get_comisiones_simple('5', '2021');
    ...
    public function get_comisiones() {
        ...
        $this->Facart_model = new FacartModel();
        $comisiones = $this->Facart_model->get_comisiones($mes, $anio); 
        $this->Facart3_model = new Server03Model();
        $comisiones3 = $this->Facart3_model->get_comisiones_simple($mes, $anio,3);        
        $comisiones2 = $this->Facart3_model->get_comisiones_simple($mes, $anio,2);
