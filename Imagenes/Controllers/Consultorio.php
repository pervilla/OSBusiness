...
class Consultorio extends BaseController {
    ...
    public function actualiza_historia(){
        ...
        $this->HistoriaModel = new HistoriaModel();
        $this->HistoriaModel->upd_historia($CODHIS,$data);        
    }
    ...
    public function set_campania(){
        $data = array(
            'CAM_CODMED' => $this->request->getVar('idcliente'),
            'CAM_FEC_INI' => date('d/m/Y', strtotime($this->request->getVar('reservationdatetimeval'))),
            'CAM_FEC_FIN' => date('d/m/Y', strtotime($this->request->getVar('reservationdatetimeendval'))),
            'CAM_HOR_INI' => date('d/m/Y h:i:s A', strtotime($this->request->getVar('reservationdatetimeval'))),
            'CAM_HOR_FIN' => date('d/m/Y h:i:s A', strtotime($this->request->getVar('reservationdatetimeendval'))),
            'CAM_DESCRIP' => $this->request->getVar('descrip')
        ); 
        $this->Caja = new CampaniaModel();
        $this->Caja->crear_campania($data);
        return redirect()->to('consultorio/campania')->with('success', 'Campaña updated successfully');
    }
