...
Begin VB.Form Frmcospro 
   ...
   Begin VB.Frame fracambio 
      Caption         =   "Productos con mucha variaci�n :"
      Height          =   3195
      Left            =   -30
      TabIndex        =   25
      Top             =   3570
...
'Else
'  MsgBox "No Permite Cambiar en esta Compa�ia", 48, Pub_Titulo
'  Exit Sub
'End If
LK_ACCESO_REPORT = ""
Load frmclave2
...
lblvar.Caption = "0% Variaci�n(B)"
Else
lblvar.Caption = Trim(tab_llave!TAB_NOMLARGO) & "% Variaci�n(B)"
End If
...
Dim I As Integer
Dim Y As Integer
WONL_INICIO = InputBox("Iniciar con Numero de Orden N� ", "Inicializar", 0)
...
End If
wvalor = InputBox("Cambiar Estado B para El Porcentaje de Variaci�n del Costo : %", "Cambiar Porcentaje", wvalor)
If wvalor = "" Then Exit Sub
...
gridcabe.TextMatrix(0, 1) = "Descripci�n"
...
If chefac.Value = 1 Then
   ...
   Else
      If Format(txtfecha, "dd/mm/yyyy") <> Format(far_llave!FAR_fecha_compra, "dd/mm/yyyy") Then
        MsgBox "La Fecha de Emisi�n del Documento no Coincide con la Fecha Inicial del Costeo " & Chr(13) & "Fecha de Emisi�n del Documento : " & Format(far_llave!FAR_fecha_compra, "dd/mm/yyyy"), 48, Pub_Titulo
        txtfecha.Text = Format(far_llave!FAR_fecha_compra, "dd/mm/yyyy")
        ProgBar.Visible = False
        Command1.Enabled = True
        Exit Sub
