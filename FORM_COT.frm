...
If par_llave!par_flag_cierre = 9 Then
   MsgBox "!!! Compa�ia a Cerredo Operaciones ... ", 48, Pub_Titulo
   Exit Sub
End If
If par_llave!PAR_FECHA_DIA <> LK_FECHA_DIA Then
   MsgBox "LA FECHA DE LA COMPA�IA HA CAMBIADO NO COINCIDE CON LA ACTUAL , OTRO USUARIO A CERRADO EL DIA!!! SALGA Y REINICIE SU SISTEMA...", 48, Pub_Titulo
   End
   Exit Sub
End If
