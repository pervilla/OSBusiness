...
Begin VB.Form FrmVen 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tabs            =   2
      TabHeight       =   520
      TabCaption(0)   =   "Definici�n de Serie"
      TabPicture(0)   =   "FrmVend.frx":0446
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "F2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Archivos de Impresi�n"
      ...
      Begin VB.Frame F2 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "Serie de Guia de Remisi�n :"
            Height          =   375
            Index           =   18
            Left            =   120
            TabIndex        =   56
      ...
      Begin VB.Label Label19 
         Caption         =   "Serie Factura Electronica"
         Height          =   375
         Left            =   -69300
         TabIndex        =   112
         Top             =   360
      ...
      Begin VB.Label Label20 
         Caption         =   "Serie Boleta Electronica"
         Height          =   375
         Left            =   -69300
         TabIndex        =   111
         Top             =   1155
      ...
      Begin VB.Label Label21 
         Caption         =   "Serie N.C. Fac. Electronica"
         Height          =   375
         Left            =   -69300
         TabIndex        =   110
         Top             =   1950
      ...
      Begin VB.Label Label22 
         Caption         =   "Serie N. D. Fac. Electronica"
         Height          =   375
         Left            =   -69300
         TabIndex        =   109
         Top             =   2745
      ...
      Begin VB.Label Label23 
         Caption         =   "Serie N.C. Bol. Electronica"
         Height          =   375
         Left            =   -67905
         TabIndex        =   108
         Top             =   1950
      ...
      Begin VB.Label Label24 
         Caption         =   "Serie N. D. Bol. Electronica"
         Height          =   375
         Left            =   -67890
         TabIndex        =   107
         Top             =   2715
   ...
   Begin VB.Label Label2 
      AutoSize        =   -1  'True
      Caption         =   "! Talonarios esta Definido por Compa�ia !"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
...
ven_llave!vem_serie_b_el = Val(txtserbolel.Text)
ven_llave!vem_serie_f_el = Val(txtserfacel.Text)
ven_llave!VEM_SERIE_NC_EL = Val(txtserncel.Text)
ven_llave!VEM_SERIE_ND_EL = Val(txtserndel.Text)
ven_llave!VEM_SERIE_NCB_EL = Val(txtserncbel.Text)
ven_llave!VEM_SERIE_NDB_EL = Val(txtserndbel.Text)
...
' SOLO COMPA�IA ACTUAL
 ...
 For fila = 0 To lfvta.ListCount - 1
     ...
     psfv!FV_TIPO = 1
     psfv!FV_CODIGO = (ven_llave!VEM_CODVEN)
...
txtserbolel.Text = Nulo_Valor0(ven_llave!vem_serie_b_el)
txtserfacel.Text = Nulo_Valor0(ven_llave!vem_serie_f_el)
txtserncel.Text = Nulo_Valor0(ven_llave!VEM_SERIE_NC_EL)
txtserndel.Text = Nulo_Valor0(ven_llave!VEM_SERIE_ND_EL)
txtserncbel.Text = Nulo_Valor0(ven_llave!VEM_SERIE_NCB_EL)
txtserndbel.Text = Nulo_Valor0(ven_llave!VEM_SERIE_NDB_EL)
...
talterno.Text = Val(Nulo_Valor0(ven_llave!VEM_ALTERNO))
...
Do Until X.EOF
  ...
  pub_cadena = "SELECT * FROM FVENTAS WHERE FV_CODCIA = '" & LK_CODCIA & "' AND FV_TIPO = 1 AND FV_KEYFV = " & X!TAB_NUMTAB & " AND FV_CODIGO = " & (ven_llave!VEM_CODVEN)
  Set psfv = CN.OpenResultset(pub_cadena, rdOpenKeyset, rdConcurValues) ' rdConcurReadOnly) ', rdConcurLock)
...
If Left(cmdAgregar.Caption, 2) = "&A" Then
    ...
    DESBLOQUEA_TEXT talterno, lfvta
    remi.Enabled = True
...
BLOQUEA_TEXT numfac_g_f, numfac_b_f, numfac_f_f, cheguia, cheboleta, chefactura, txtdireccion, txttelecasa, txttelecelu, Check1
BLOQUEA_TEXT serie_nc, numfac_nc, numfac_nc_f, chenc, serie_nd, numfac_nd, numfac_nd_f, chend, cmblista, chedesactivo
BLOQUEA_TEXT chedesactivo, talterno, lfvta
remi.Enabled = False
txtfechaing.Enabled = False
Txt_key.Enabled = True
F2.Visible = False
