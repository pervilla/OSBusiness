...
Begin VB.Form frmTImport 
   Caption         =   "Transfer. Export. (Envio de Informaci�n)"
   ClientHeight    =   6180
   ClientLeft      =   555
   ClientTop       =   1845
   ClientWidth     =   4950
...
If Trim(Nulo_Valors(GEN!GEN_CIAEXP)) = "" Then
 MsgBox "Codigo de Compa�ia de Recepci�n de informacion no validad...", 48, Pub_Titulo
 Exit Sub
End If
...
MsgBox "Proceso de Terminado Satisfactoriamente " & Chr(13) & "Total de Registros : " & CONTADOR & Chr(13) & "DEL :" & txtCampo1.Text & "  AL " & txtCampo2.Text & Chr(13) & "Ubicaci�n de Archivo :  " & Trim(transfer.DatabaseName), 48, Pub_Titulo
