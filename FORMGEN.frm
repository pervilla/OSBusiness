...
Begin VB.Form FORMGEN 
   ...
   Begin VB.Frame fraprecios 
      ...
      Visible         =   0   'False
      Width           =   11925
      Begin VB.CommandButton CmdCompSin 
         Caption         =   "Indicaciones/Otros"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label lblp 
         ...
         Width           =   3165
      End
      Begin VB.Label LBLAGOTADO 
         BackStyle       =   0  'Transparent
         Caption         =   "Agotado/Distribuidor"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label lblp 
         BackStyle       =   0  'Transparent
         Caption         =   "Precio 2 :    Precio 3 :    Precio 4     Precio 6:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fradocpen 
      ...
      Begin VB.Label lblp 
         Alignment       =   1  'Right Justify
         BackStyle       =   0  'Transparent
         Caption         =   "<Enter para Seleccionar>"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fracc 
      Caption         =   "Destino de Centro de Costo : [F8]=Cambiar           Zona de Distribuir              "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin MSComctlLib.ListView LV_VEN 
      ...
      NumItems        =   0
   End
   Begin VB.Frame frainfoCC 
      Caption         =   "Saldos Pendientes por Centro de Costo :"
      ForeColor       =   &H00400000&
      Height          =   2415
      Left            =   13800
      TabIndex        =   284
      ...
      Visible         =   0   'False
      Width           =   4335
      Begin MSFlexGridLib.MSFlexGrid gridinfocc 
         Height          =   2055
         Left            =   120
         TabIndex        =   285
         Tag             =   "9999"
   ...
   Begin VB.TextBox i_CodCaj 
      ...
      Width           =   765
   End
   Begin VB.ComboBox i_vendlst 
      BackColor       =   &H00E0E0E0&
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":0446
      Left            =   2640
      List            =   "FORMGEN.frx":0448
      Style           =   2  'Dropdown List
      TabIndex        =   264
      Tag             =   "9999"
      Top             =   1680
   ...
   Begin VB.Frame fraPedidos 
      ...
      Visible         =   0   'False
      Width           =   10095
      Begin VB.CommandButton cmdchequea 
         Caption         =   "Che&quear Pend."
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.TextBox txtCodVen 
         ...
         Width           =   555
      End
      Begin MSFlexGridLib.MSFlexGrid Grid_detalle 
         Height          =   3945
         Left            =   120
         TabIndex        =   202
         Tag             =   "9999"
      ...
      End
      Begin VB.Label lblped 
         Caption         =   "Porcesando Informaci�n..."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.CommandButton cmdpedidos 
      BackColor       =   &H00E0E0E0&
      Caption         =   "&Facturaci�n por Pedidos"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.ComboBox i_situacion 
      ...
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":088C
      Left            =   7995
      List            =   "FORMGEN.frx":0896
      Style           =   2  'Dropdown List
      TabIndex        =   135
      Tag             =   "133"
      Top             =   12135
   ...
   Begin VB.ComboBox i_tipdoc 
      ...
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":2006
      Left            =   1080
      List            =   "FORMGEN.frx":2008
      Style           =   2  'Dropdown List
      TabIndex        =   49
      Tag             =   "16"
      Top             =   840
   ...
   Begin VB.ComboBox i_is 
      ...
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":200A
      Left            =   1080
      List            =   "FORMGEN.frx":2014
      Style           =   2  'Dropdown List
      TabIndex        =   122
      Tag             =   "0"
      Top             =   1080
   ...
   Begin VB.ComboBox i_fbg 
      ...
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":2034
      Left            =   2280
      List            =   "FORMGEN.frx":2041
      Style           =   2  'Dropdown List
      TabIndex        =   73
      Tag             =   "14"
      Top             =   2880
   ...
   Begin VB.ComboBox i_ds 
      ...
      ForeColor       =   &H00000080&
      Height          =   315
      ItemData        =   "FORMGEN.frx":204E
      Left            =   1080
      List            =   "FORMGEN.frx":2058
      Style           =   2  'Dropdown List
      TabIndex        =   75
      Tag             =   "76"
      Top             =   720
   ...
   Begin VB.ComboBox i_cant_cheq 
      Height          =   315
      ItemData        =   "FORMGEN.frx":2062
      Left            =   6360
      List            =   "FORMGEN.frx":2064
      TabIndex        =   66
      Tag             =   "65"
      Text            =   "i_cant_cheq"
      Top             =   1560
   ...
   Begin VB.ComboBox i_tipo_bloq_act4 
      ...
      ForeColor       =   &H00000080&
      Height          =   285
      ItemData        =   "FORMGEN.frx":2066
      Left            =   600
      List            =   "FORMGEN.frx":2068
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   60
      Tag             =   "59"
   ...
   Begin VB.ComboBox i_tipo_bloq_act3 
      ...
      ForeColor       =   &H00000080&
      Height          =   285
      ItemData        =   "FORMGEN.frx":206A
      Left            =   615
      List            =   "FORMGEN.frx":206C
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   59
      Tag             =   "58"
   ...
   Begin VB.ComboBox i_tipo_bloq_act2 
      ...
      ForeColor       =   &H00000080&
      Height          =   285
      ItemData        =   "FORMGEN.frx":206E
      Left            =   600
      List            =   "FORMGEN.frx":2070
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   58
      Tag             =   "57"
   ...
   Begin VB.ComboBox i_tipo_bloq_act1 
      ...
      ForeColor       =   &H00000080&
      Height          =   285
      ItemData        =   "FORMGEN.frx":2072
      Left            =   600
      List            =   "FORMGEN.frx":2074
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   57
      Tag             =   "56"
   ...
   Begin VB.ComboBox i_codsunat 
      ...
      Height          =   315
      IntegralHeight  =   0   'False
      ItemData        =   "FORMGEN.frx":2076
      Left            =   3120
      List            =   "FORMGEN.frx":2078
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   46
      Tag             =   "12"
      ...
      If Val(ven_llave!VEM_AM_LISTA) = 13 Then
        ...
        Else
         If (Val(grid_fac.TextMatrix(grid_fac.Row, 4)) * Val(pre_llave!PRE_EQUIV)) >= Val(pre_llave!PRE_CANT) Then
          ...
          Else
            MsgBox "No cumple la condici�n para el Precio Asignado.", 48, Pub_Titulo
            i_precios.AddItem ""
...
If FORMGEN.i_cias.Visible Then
 If FORMGEN.i_cias.ListCount = 0 Then
   MsgBox " Debe Configurar la Compa�ia de Destino..", 48, Pub_Titulo
 Else
...
Private Sub pasa_cabeza()
   grid_fac.TextMatrix(0, 0) = "Descripci�n del Articulo"
   ...
   If Trim(gridl.TextMatrix(FILAX, 0)) <> "" Then
         If LK_CODTRA = 1455 And Val(gridl.TextMatrix(FILAX, 5)) <> 0 And Trim(i_tipdoc.Text) = "LE" Then
            If Val(gridl.TextMatrix(FILAX, 5)) <> Val(gridl.TextMatrix(FILAX, 25)) Then
               MsgBox "Importe debe ser Cancelaci�n"
...
ws_artkey = 0
If loc_key > 0 Then
    ws_artkey = Val(LV_ART.ListItems.Item(loc_key).SubItems(1))
    ws_nomart = LV_ART.ListItems.Item(loc_key).Text
ElseIf Val(grid_fac.TextMatrix(grid_fac.Row, 1)) > 0 Then
    ws_artkey = Val(grid_fac.TextMatrix(grid_fac.Row, 1))
    ws_nomart = grid_fac.TextMatrix(grid_fac.Row, 0)
End If
...
sale:
   Screen.MousePointer = 0
   MsgBox "Error: " & Err.Description, 48, Pub_Titulo
End Sub
...
If LK_FECHA_DIA = #1/1/1900# Then
  Screen.MousePointer = 0
  MsgBox "La Compa�ia No Tiene Definida su Fecha de Trabajo. Verificar!!!", 48, Pub_Titulo
  Unload FORMGEN
  Exit Sub
End If
...
FORMGEN.grid_fac.ColWidth(39) = 0 'Nro. Serie para relaci�n 1405
FORMGEN.grid_fac.ColWidth(40) = 0 'Nro. Documento para relaci�n 1405
FORMGEN.grid_fac.ColWidth(41) = 0 'Nro. secuancia  relaci�n 1405
...
FORMGEN.grid_fac.ColWidth(54) = 0 ' Flag_Bonificaci�n
...
If Trim(LOC_FLAG_ALLOG) = "" Or (LK_CODTRA = 1111 And Trim(loc_flag_1111) = "") Then
 ...
 con_llave.Close
 Barra.Visible = False
 MsgBox "Operaci�n incompleta, NO SE REGISTRO!, Favor de Reiniciar el Sistema..." & Chr(13) & "El Sisema se Cerrar�." & Chr(13) & "Si el problema continua llamar a su proveedor ", vbCritical, Pub_Titulo
 End
 GoTo fin
End If
   ...
   If LK_CODTRA = 2401 Then
     ...
     If Trim(FORMGEN.i_fbg.Text) = "B" Then
      ...
      Else
         ...
         MsgBox "El Tama�o del Documento no alcanza a los Item de los Articulos, pasan de lo predeterminado." & Chr(13) & "Total de Filas para Imprimir : " & Format(nrolinelotes, "00") & Chr(13) & "Tope de filas del Documento : " & Format(WS_NRO_ITEMS, "00") & Chr(13) & descrip, 48, Pub_Titulo
         GoTo fin
      End If
     ElseIf Trim(FORMGEN.i_fbg.Text) = "F" Then
      ...
      Else
         CN.Execute "Rollback Transaction", rdExecDirect
         con_llave.Close
         MsgBox "El Tama�o del Documento no alcanza a los Item de los Articulos, pasan de lo predeterminado." & Chr(13) & "Total de Filas para Imprimir : " & Format(nrolinelotes, "00") & Chr(13) & "Tope de filas del Documento : " & Format(par_llave!par_fac_lines, "00") & Chr(13) & descrip, 48, Pub_Titulo
         GoTo fin
      End If
...
'      If PUB_TIPMOV = 94 Then far_llave!FAR_COSTEO = "A"
   ...
   '   End If
      ...
      far_llave!far_key_dircli = Val(Right(i_dircli.Text, 8))
        ...
        marca_especial 0 ' al FACART rutina para marcar la vta �ra distribuidra
        far_llave.Update
...
If loc_mofi_venta <> "A" And Val(Grid_all.TextMatrix(Grid_all.Row, 2)) Then
  'BolFac_Click
  MsgBox "No tiene Acceso a modificar documentos anteriores a la fecha del d�a", vbExclamation, Pub_Titulo
  Exit Sub
End If '
End If
...
If (Val(Grid_all.TextMatrix(Grid_all.Row, 2)) = 1401) And Val(Grid_all.TextMatrix(Grid_all.Row, 18)) <> 0 Then
  ...
  If far_llave2.EOF Then
     MsgBox "No Procede ... Extornar la Cancelaci�n...", 48, Pub_Titulo
     Grid_all.SetFocus
     Exit Sub
...
Else
    If Val(Grid_all.TextMatrix(Grid_all.Row, 2)) = 5370 Or Val(Grid_all.TextMatrix(Grid_all.Row, 2)) = 5375 Then
     MsgBox "No Procede, Anular esta operaci�n , Solo Usuario ADMIN"
     Exit Sub
    End If
End If
If Val(Grid_all.TextMatrix(Grid_all.Row, 2)) = 2401 Then
...
If LK_CODTRA = 2401 And grid_fac.COL = 1 And loc_acc_descto = "A" Then
  ...
  If X.EOF Then
     MsgBox "Producto No procede para Bonificaci�n", 48, Pub_Titulo
     Exit Sub
  End If
...
'    MsgBox "!!! Compa�ia ... debe Costear Productos antes de Enviar ", 48, Pub_Titulo
'    Exit Sub
'  End If
'End If
End Sub
   ...
   If cli_llave!cli_codclie = Val(i_codcli.Text) Then
      ...
      If LK_CODTRA = 2401 And LK_EMP <> "HER" Then
         ...
         ElseIf i_condi.ListCount = 0 Then
            MsgBox "No Existe definici�n de Descuentos.", 48, Pub_Titulo
            i_condi.Enabled = False
            i_codcli.Text = ""
         Else
...
transfer:
   ...
   If FAR_REG!far_transito = "X" Then
      ...
      If FAR_REG!far_transito = "T" Then
         MsgBox "El sistema detect� que el proceso fue interrumpido ...Se iniciar� el proceso complementario ... "
      End If
      FAR_REG.MoveLast
      PUB_NUMFAC = 0
...
If LK_CODTRA = 2401 And i_cambio.Value = 0 Then
   ...
   If loc_var_descto = 0 Then
      MsgBox "Cliente no Tiene definici�n de Descuento.", 48, Pub_Titulo
   End If
   FORMGEN.grid_fac.Clear
   pasa_cabeza
   grid_fac.Rows = 3
...
If gridl.Visible And Val(gridl.TextMatrix(1, 5)) <> 0 Then
   ...
   If Abs(Val(ww_tc) - Val(LK_TIPO_CAMBIO)) > 0.4 Then
     MsgBox "Existe mucha Diferencia en el T.C. Anterior, si todavia desea aplicar su T.C. debe dar click en la opci�n de T.C. para cambiarlo ", 48, Pub_Titulo
...
If i_cambio.Value = 1 And i_cambio.Visible Then
   ...
   LABELGEN(16).Caption = "Fec. Emisi�n:"
...
'  MsgBox "N�. Documento: " + i_numser.Text + " - " + i_numfac.Text + "  - est�  Emitido...no procede", 48, Pub_Titulo
'  i_numfac.Text = ""
'  i_numfac.SetFocus
'  i_cambio.Value = 0
'  BolFac_Click
...
If LK_CODTRA = 1401 Or (LK_CODTRA = 2401 And far_llave!far_signo_car <> 0) Then
    ...
    LEER_CAR_LLAVE
    If car_far.EOF Then
        MsgBox "Observaci�n: < Documento ha sido Anulado. >", 48, Pub_Titulo
    Else
      car_far.MoveLast
  ...
  If far_llave!FAR_ESTADO2 = "L" Then
   ...
   'pedir clave para usar un documento anulado
      If flag_pase <> "A" And LK_CODTRA = 2401 Then
        MsgBox "Debe Ingresar la Clave de Gerencia para usar un Numero de Documento Anulado, de lo contrario mostrar� el nro. correlativo.", 48, Pub_Titulo
        LK_ACCESO_REPORT = ""
        Load frmclave2
        Screen.MousePointer = 0
        frmclave2.Show 1
...
If LK_EMP = "HER" And PUB_TIPMOV = 10 Then
   If Val(Format(grid_fac.TextMatrix(grid_fac.Row, 35), "0.00")) < Val(Format(WS_COSTO, "0.00")) Then
     par_llave.Requery
     If par_llave!PAR_FLAG_P <> "P" Then
       MsgBox "El Precio Elegido Es Menor (� sin costo), que el Costo y NO PROCEDE !!!", 48, Pub_Titulo
       grid_fac.TextMatrix(grid_fac.Row, 35) = ""
       grid_fac.TextMatrix(grid_fac.Row, 32) = ""
...
If PUB_TIPMOV = 10 And Nulo_Valors(cli_llave!cli_estado) <> "A" Then
   MsgBox "              !!! O J O !!! " + Chr(13) + "Cliente No est� ACTIVO en el Sistema.", 48, Pub_Titulo
    ...
    If Val(Left(i_def.Text, 2)) > wCONDI Then
        For tf = 0 To i_def.ListCount - 1
           If wCONDI = Val(Left(i_def.List(tf), 2)) Then
              MsgBox "Condici�n No Autorizada....Verificar", 48, Pub_Titulo
              MsgBox "La Maxima Condici�n es : " & Trim(i_def.List(tf)), 48, Pub_Titulo
              i_def.ListIndex = tf
              i_def_LostFocus
           End If
        Next tf
...
If Val(i_dias.Text) > 30 Then
   pub_mensaje = " �Esta seguro del numero de Dias... ?"
     Pub_Respuesta = MsgBox(pub_mensaje, Pub_Estilo, Pub_Titulo)
  If Pub_Respuesta = vbNo Then   ' El usuario eligi�
     i_dias.SetFocus
     Exit Sub
  End If
End If
...
If LK_CODTRA = 1401 Then
  If Weekday(FORMGEN.i_fecha_vcto.Text) = 1 Or Weekday(FORMGEN.i_fecha_vcto.Text) = 7 Then
     MsgBox "El D�a no es laborable : " & UCase(Format(FORMGEN.i_fecha_vcto.Text, "dddd dd mmmm , yyyy")), 48, Pub_Titulo
     NUMERO = FORMGEN.i_dias.WhatsThisHelpID
     avanza_campo
 End If
End If
...
If rs_datos.EOF Then
  MsgBox "La Compra no tiene la Relaci�n de codigo", 48, Pub_Titulo
  Exit Sub
End If
...
If subtra_llave.EOF Then
  MsgBox "No Existe Codigo de Operaci�n.", 48, Pub_Titulo
  Azul TRANS, TRANS
  Exit Sub
End If
...
If Trim(loc_codoper) = "2107" Then
   MsgBox "No Pertenece a este M�dulo.", 48, Pub_Titulo
   GoTo SALIR
End If
 ...
 '  If ((Val(FORMGEN.i_limcre.Text) > Val(FORMGEN.i_limcre_ant.Text)) And Val(FORMGEN.i_limcre_ant.Text) <> 0) Or (Val(FORMGEN.i_dias.Text) > Val(cli_llave!CLI_AUTO1)) Then
    ...
    If loc_acc_unCC = "A" Then
      ...
      Else
         ...
         MsgBox "Solo Puede Cambiar Valores al 1 o 0 en Adicionar un Contado � Adicional de Creditos.", 48, Pub_Titulo
         Exit Function
      End If
      '
    Else
...
pase_esp:
 ...
 Else
    MsgBox "La casilla de Tipo de Limite de Credito :[ 0 es normal y 1 especial para el mismo d�a ]", 48, Pub_Titulo
    FORMGEN.i_serguia.SetFocus
    GoTo salirf
 End If
 If i_numguia.Text = 0 Or i_numguia.Text = 1 Then
 Else
    MsgBox "La Casilla de Tipo de Acceso a Contados :[ 0 sin acceso y 1 especial para el mismo d�a ]", 48, Pub_Titulo
...
If NJ.Visible = True And LK_ACTIVA = "A" Then
   ...
   Else
      MsgBox "Confirmar la Operaci�n...", 48, Pub_Titulo
      GoTo salirf
   End If
...
If i_fecha_compra.Visible Then
  If CDate(i_fecha_compra.Text) > LK_FECHA_DIA Then
    MsgBox "La Fecha de Emisi�n no puede ser Mayor a la de Proceso.", 48, Pub_Titulo
...
If i_fecha_can.Visible Then
 If CDate(i_fecha_can.Text) > LK_FECHA_DIA Then
    MsgBox "La Fecha de Operaci�n no puede ser Mayor a la de Proceso.", 48, Pub_Titulo
    Azul2 i_fecha_can, i_fecha_can
    GoTo salirf
  End If
End If
...
If LK_CODTRA = 2401 Then
 ...
 If Val(Right(cmdtipo.Text, 8)) = 0 Then
    MsgBox "Verificar la Condici�n de la Venta", 48, Pub_Titulo
    cmdtipo.SetFocus
    GoTo salirf
 End If
 If LK_CODCIA = "01" Then
...
If LK_CODTRA = 2409 Then
  If Trim(FORMGEN.i_cias.Text) = "" Then
    MsgBox "No procede Configurar la Compa�ia de Destino ", 48, Pub_Titulo
    GoTo salirf
  End If
End If
...
If LK_CODTRA = 2412 Then
 ...
 If pub_signo_arm <> 0 Then
    If Val(grid_fac.TextMatrix(1, 4)) = 0 Then
      MsgBox "La operaci�n requiere registro de Producto, Verificar", 48, Pub_Titulo
      GoTo salirf
    End If
 End If
...
If Val(gridl.TextMatrix(1, 5)) = 0 And (LK_CODTRA = 2412 Or LK_CODTRA = 2410) Then
        If pub_signo_car <> 0 Then
          pub_mensaje = "El Importe se Abonar� a su Cuenta Corriente...Desea Continuar? "
        Else
...
If Boton_Letras.Visible = True Or LK_CODTRA = 2770 Or LK_CODTRA = 2774 Then
          ...
          For filafac = 2 To gridl.Rows - 1
              ...
              If Val(gridl.TextMatrix(filafac, 19)) <> 0 Then
                 ...
                 If Trim(gridl.TextMatrix(filafac, 20)) = "" Then
                        MsgBox "Colocar Identificador o numero de Cheque  al N�.Doc: " & Trim(gridl.TextMatrix(filafac, 1)) & "/" & Trim(gridl.TextMatrix(filafac, 2)) & "-" & Trim(gridl.TextMatrix(filafac, 3)), 48, Pub_Titulo
                        CONTADOR = 6
                 End If
              End If
         ...
         If Val(SUT_LLAVE!SUT_SIGNO_CAR) = 2 Then
            If Val(gridl.TextMatrix(1, 5)) <> 0 Then
                  MsgBox "Los importes de los documentos deben ser iguiales para la Liquidaci�n...", 48, Pub_Titulo
                  GoTo salirf
            End If
         End If
End If
...
If grid_canje.Visible = True Then
    ...
    End If
    If CONTADOR = 88 Then
       MsgBox "Fechas de Vencimiento no pueden ser anteriores de la Fecha de Emisi�n", 48, Pub_Titulo
       GoTo salirf
    End If
End If
...
If grid_fac.Visible And LK_CODTRA = 2401 And Nulo_Valors(SUT_LLAVE!SUT_CERO) = "A" And Trim(SUT_LLAVE!SUT_abreviado) <> "CONS" Then
 If Val(grid_fac.TextMatrix(1, 7)) = 0 Then
    ...
    Else
       pub_mensaje = "Es  Anulaci�n o en Blanco  del Documento :" & BolFac.Caption & "-" & i_numser.Text & " " & i_numfac.Text & " Continuar ..?"
    End If
    If loc_acceso_vtablanco <> "A" Then
        MsgBox "Venta sin informaci�n , No Procede(sin acceso)", 48, Pub_Titulo
        GoTo salirf
    Else
        Pub_Respuesta = MsgBox(pub_mensaje, Pub_Estilo)
        If Pub_Respuesta = vbNo Then
...
If (LK_CODUSU = "ADMIN" Or LK_CODUSU = "SUPER") And (par_llave!PAR_FECHA_DIA <> LK_FECHA_DIA) Then
    pub_mensaje = "Esta Usando Fecha Diferente al de D�a del sistema...?"
    Pub_Respuesta = MsgBox(pub_mensaje, Pub_Estilo, Pub_Titulo)
    If Pub_Respuesta = vbNo Then GoTo salirf
Else
...
If LK_CODTRA = 1111 And LK_EMP <> "3AA" Then
  ...
  Else
    MsgBox "El Documento es del : " & CDate(FORMGEN.Grid_all.TextMatrix(Grid_all.Row, 11)) & " periodo cerrado... No Procede la anulaci�n ", 48, Pub_Titulo
    GoTo salirf
  End If
End If
...
If pub_signo_caja = -1 And LK_CODTRA <> 2412 Then
   ...
   If WS_IMP_REG > WS_CAJA_SAL Then
     MsgBox "Operaci�n no procede,  el Saldo de Caja es Menor q el Monto a Registrar" & Chr(13) & " Saldo: " & Format(WS_CAJA_SAL, "#,##0.00"), 48, Pub_Titulo
     GoTo salirf
   End If
...
If ps_vercia.EOF Then
   MsgBox "No Existe Nro de Pedidos o esta sin Marcar la Opci�n PRE-PEDIDO. Verificar", 48, Pub_Titulo
   Exit Sub
End If
IFIL = 2
...
ElseIf LK_CODTRA = 2403 Then
  TF_TIPMOV = 28
Else
  MsgBox "Proceso Automatica no procede en esta Transaci�n", 48, Pub_Titulo
  Exit Sub
End If
...
loc_pase_bloq = 1
grid_fac.TextMatrix(0, 0) = "Descripci�n del Articulo BLOQUEADO !!! "
End Sub
