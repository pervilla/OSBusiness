...
Reportes.WindowTitle = "KARDEX N� :" & Format(PU_NUMSER, "000") & " - " & Format(PU_NUMFAC, "0000000")
...
If grid_che.COL = 2 Then
    ...
    If cheest_llave.EOF Then
       ...
       Exit Sub
    End If
    wfecha = InputBox("Cambiar Fecha Emisi�n : " & grid_che.TextMatrix(grid_che.Row, 2), "Cambiar", grid_che.TextMatrix(grid_che.Row, 2))
    If Not IsDate(wfecha) Then Exit Sub
    cheest_llave.Edit
...
If grid_che.COL = 9 Then
    ...
    If cheest_llave.EOF Then
       ...
       Exit Sub
    End If
    'wfecha = InputBox("Cambiar Fecha Emisi�n : " & grid_che.TextMatrix(grid_che.Row, 2), "Cambiar")
    'If Not IsDate(wfecha) Then Exit Sub
...
frm_cheques.grdr.TextMatrix(0, 1) = "Descripci�n"
