...
Begin VB.Form RCRYSTAL 
   ...
   Begin VB.Frame fralistapre 
      ...
      Begin VB.ComboBox cmblistapre 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmRepoCrystal.frx":57E2
         Left            =   240
         List            =   "frmRepoCrystal.frx":57EC
         Style           =   2  'Dropdown List
         TabIndex        =   167
         Top             =   240
         Width           =   2295
   ...
   Begin VB.Frame frauser 
      ...
      Begin VB.ComboBox cmduser 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmRepoCrystal.frx":5801
         Left            =   120
         List            =   "frmRepoCrystal.frx":580B
         Style           =   2  'Dropdown List
         TabIndex        =   114
         Top             =   240
         Width           =   2415
   ...
   Begin VB.Frame fraCatABC 
      ...
      Begin VB.ListBox LSTabc 
         Height          =   735
         ItemData        =   "frmRepoCrystal.frx":5820
         Left            =   240
         List            =   "frmRepoCrystal.frx":582D
         Style           =   1  'Checkbox
         TabIndex        =   159
         Top             =   240
         Width           =   1335
   ...
   Begin VB.CommandButton multifamusu 
      ...
      Height          =   255
      Left            =   2400
      Picture         =   "frmRepoCrystal.frx":5853
      Style           =   1  'Graphical
      TabIndex        =   138
      Top             =   5640
      Visible         =   0   'False
   ...
   Begin VB.CommandButton multifam 
      ...
      Height          =   255
      Left            =   0
      Picture         =   "frmRepoCrystal.frx":5C95
      Style           =   1  'Graphical
      TabIndex        =   119
      Top             =   5640
      Visible         =   0   'False
   ...
   Begin VB.Frame framoneda 
      ...
      Begin VB.ComboBox cmdmoneda 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmRepoCrystal.frx":60D7
         Left            =   120
         List            =   "frmRepoCrystal.frx":60E1
         Style           =   2  'Dropdown List
         TabIndex        =   36
         Top             =   240
         Width           =   1215
   ...
   Begin VB.Frame fraclipro 
      ...
      Begin VB.ComboBox cmbclipro 
         Height          =   315
         ItemData        =   "frmRepoCrystal.frx":60F6
         Left            =   120
         List            =   "frmRepoCrystal.frx":6100
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Top             =   480
         Width           =   1575
   ...
   Begin VB.CommandButton cmdCerrar 
      ...
      Height          =   735
      Left            =   10440
      Picture         =   "frmRepoCrystal.frx":6120
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   3960
      Width           =   1095
   ...
   Begin VB.CommandButton Pantalla 
      ...
      Height          =   750
      Left            =   10440
      Picture         =   "frmRepoCrystal.frx":626A
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   2880
      Width           =   1095
...
If Val(Left(cmblistpv.Text, 2)) = 0 Then
   MsgBox "NO Procede la Eliminaci�n , Verificar ", 48, Pub_Titulo
   Exit Sub
End If
...
If retra_llave!tra_s12 = 1 Or retra_llave!TRA_S9 = 1 Or retra_llave!TRA_ACT11 = 1 Or retra_llave!TRA_S6 = 1 Or Wfile = "KARDEX_CLASES" Then
 ...
 If lk_acc_repoall = 1 Then
 WCIASMST = Trim(par_llave!par_art_cias)
 Else
 WCIASMST = Trim(par_llave!PAR_CIAGRUPO)
 End If
 For fila = 1 To 40 Step 2
   PUB_CODCIA = Mid(Trim(WCIASMST), fila, 2)
...
If Wfile = "REG_BANCOS" Then
  ...
  frag.Visible = True
End If
If Wfile = "REG_COMPRA_COM" Or Wfile = "REG_COMPRA_NORMA234" Then
  frapasa.Visible = True
  If Not cop_llave.EOF Then
   cop_fecha1.Caption = Format(cop_llave!cop_fecha_proceso, "dd/mm/yy")
   cop_fecha2.Caption = Format(cop_llave!cop_fecha_proceso2, "dd/mm/yy")
...
If Left(Wfile, 10) = "CTA_CONSOL" Then
 ...
 ' End If
  ...
  cmblistpv.AddItem "Mostrar Seg�n Fechas de Reporte..."
  cmbtipdoc.AddItem " "
...
If Wfile = "CAJVALOR2.RPT" Then
    PUB_TIPREG = 86
    PUB_CODCIA = "00"
    SQ_OPER = 2
    LEER_TAB_LLAVE
    cbo_grupo.ToolTipText = "TAB_TIPREG = 86"
    cbo_grupo.Clear
    Do Until tab_mayor.EOF
        cbo_grupo.AddItem tab_mayor!TAB_NOMLARGO & String(80, " ") & tab_mayor!TAB_NUMTAB
        tab_mayor.MoveNext
    Loop
    fra_grupo.Visible = True
End If

If Wfile = "CLIVCTOENEW.RPT" Then
    PUB_TIPREG = 144
    PUB_CODCIA = "00"
    SQ_OPER = 2
    LEER_TAB_LLAVE
    cmb_tipocli.ToolTipText = "TAB_TIPREG = 144"
    cmb_tipocli.Clear
    Do Until tab_mayor.EOF
        cmb_tipocli.AddItem tab_mayor!TAB_NOMLARGO & String(80, " ") & tab_mayor!TAB_NUMTAB
        tab_mayor.MoveNext
    Loop
    fra_tipocli.Visible = True
End If
...
ElseIf Wfile = "REG_COMPRA_NORMA234" Then
  REG_COMPRA_NORMA234
Else
  PRO_REPORTE (0)
End If
...
Dim rs_transimerca As rdoResultset
Dim strMerca As String
...
End If
  ...
  If retra_llave!tra_con7 = 1 Then ' x FAMI
      ...
      End If
      If retra_llave!TRA_ACT11 = 0 And retra_llave!tra_s12 <> 1 Then
       If UCase(Left(Wfile, 7)) = "MAXPEDG" Then
       GoSub ActuTransito
       GoTo SINCIA
       End If
       If pub_cadena = "" Then
...
SINCIA2:
  ...
  If retra_llave!TRA_GRU7 = 1 Then
        ...
        If wfiltra <> "" Then
          ...
          If Left(cmbcodtra.Text, 4) = 5355 Then
            If pub_cadena = "" Then
              pub_cadena = pub_cadena + " {SUB_TRANSA.SUT_SECUENCIA} IN " & wfiltra & " AND {SUB_TRANSA.SUT_CODTRA} IN  [5355,2748]"
            Else
              pub_cadena = pub_cadena + " AND  {SUB_TRANSA.SUT_SECUENCIA} IN " & wfiltra & " AND {SUB_TRANSA.SUT_CODTRA} in  ['5355','2748']"
            End If
...
pasa_prostock:
  ...
  If Wfile = "LISTAPERSONAL.RPT" Then ' MILTON
     If pub_cadena = "" Then
        pub_cadena = "{CLIENTES.CLI_CODCIA} = '" & LK_CODCIA & "'"
     Else
        pub_cadena = pub_cadena & " AND {CLIENTES.CLI_CODCIA} = '" & LK_CODCIA & "'"
     End If
  End If
  ...
  If Wfile = "CAJVALOR2.RPT" Then
     If cbo_grupo.Text <> "" Then
        pub_cadena = pub_cadena & "  AND {SUB_TRANSA.SUT_GRUPO} = " & Val(Right(cbo_grupo.Text, 4)) & " "
     End If
  End If
    
  If Wfile = "CLIVCTOENEW.RPT" Then
     If cmb_tipocli.Text <> "" Then
        pub_cadena = pub_cadena & "  AND {CLIENTES.CLI_TIPOCLI} = " & Val(Right(cmb_tipocli.Text, 4)) & " "
     End If
  End If
...
CN.Execute "UPDATE ARTICULO SET ARM_STOCK_T = 0 WHERE  ARM_STOCK_T <> 0 "
strMerca = "SELECT FAR_CODCIA ,FAR_CODART , SUM(FAR_CANTIDAD) AS CANTIDAD FROM ARTI,FACART  WHERE (ART_CODCIA = FAR_CODCIA) AND (ART_KEY = FAR_CODART) " & _
" AND FAR_CODCIA  <> '30' AND FAR_FECHA_COMPRA >= '" & Format(LK_FECHA_DIA - 60) & "' AND FAR_TIPMOV = 100 AND FAR_TRANSITO = 'T' AND FAR_ESTADO <> 'E' GROUP BY FAR_CODCIA , FAR_CODART "
Set rs_transimerca = CN.OpenResultset(strMerca, rdOpenKeyset, rdConcurValues) ' rdConcurReadOnly) ', rdConcurLock)
Do Until rs_transimerca.EOF
   CN.Execute "UPDATE ARTICULO SET ARM_STOCK_T = " & rs_transimerca!cantidad & "  WHERE ARM_CODCIA = '" & rs_transimerca!FAR_CODCIA & "' AND ARM_CODART = " & rs_transimerca!far_codart
  rs_transimerca.MoveNext
Loop
...
Set ps_pve = CN.OpenResultset(pub_cadena, rdOpenKeyset, rdConcurValues) ' rdConcurReadOnly) ', rdConcurLock)
cmblistpv.Clear
cmblistpv.AddItem "00 - Mostrar Seg�n Fechas de Reporte..."
If ps_pve.EOF Then
...
End Sub
Public Sub REG_COMPRA_NORMA234()
On Error GoTo FINTODO
Dim wnrocorr As Currency
Dim addcia  As String
   Dim movcc_obra As String
   Dim movcc_fecha As String
   Dim movcc_glosa As String
   Dim movcc_moneda As String
   Dim movcc_codcta As String
   Dim movcc_dh As String
   Dim movcc_importe As String
   Dim movcc_sunat As String
   Dim movcc_serie As String
   Dim movcc_numfac As String
   Dim movcc_codclie As String
   Dim movcc_cp As String
   Dim movcc_fbg As String
   Dim movcc_fecha_emi As String
   Dim movcc_fecha_vcto As String
   Dim movcc_cc As String
   Dim movcc_imp_dol As String
   Dim movcc_tipo_gasto As String


Dim movcc_llave As rdoResultset
Dim PSMOVCC_LLAVE As rdoQuery

Dim ws_nro_voucher As Currency
Dim WS_NRO_MOV As Integer
   
Dim filtro_cc As String
Dim filtro_tg As String
Dim Lini As Integer
Dim Lfin As Integer
Dim qver_onlyCont As Integer
Dim CHE_IMPORTE As Currency
...
If fracc.Visible = True Then
    filtro_cc = ""
    'For fila = 0 To liscc.ListCount - 1
    '  If liscc.Selected(fila) Then
    '   filtro_cc = filtro_cc + Trim(Right(liscc.List(fila), 8)) + ", "
    '  End If
    'Next
    'If filtro_cc <> "" Then
    ' filtro_cc = Left(filtro_cc, Len(filtro_cc) - 2)
    ' filtro_cc = " AND ALL_CC IN (" & filtro_cc & ") "
    'Else
     filtro_cc = ""
    'End If

    'For fila = 0 To listipo.ListCount - 1
    'If listipo.Selected(fila) Then
   '    filtro_tg = filtro_tg + Trim(Right(listipo.List(fila), 8)) + ", "
   '   End If
   ' Next
   ' If filtro_tg <> "" Then
   ''  filtro_tg = Left(filtro_tg, Len(filtro_tg) - 2)
   '  filtro_tg = "AND ALL_DESCTO IN (" & filtro_tg & ") "
   ' Else
     filtro_tg = ""
   ' End If
...
'If chepasaoc.Value = 1 Then
'    pub_cadena = "SELECT * FROM MOVICONTCC WHERE MOV_CODCIA = ? AND MOV_PERIODO = ? AND MOV_NRO_MES = ?  AND MOV_TIPMOV = ? AND MOV_TIPDOC = ?  ORDER BY MOV_NRO_MES "
'    Set PSMOVCC_LLAVE = CN.CreateQuery("", pub_cadena)
'    PSMOVCC_LLAVE(0) = 0
'    PSMOVCC_LLAVE(1) = 0
'    PSMOVCC_LLAVE(2) = 0
'    PSMOVCC_LLAVE(3) = 0
'    PSMOVCC_LLAVE(4) = 0
'    Set movcc_llave = PSMOVCC_LLAVE.OpenResultset(rdOpenKeyset, rdConcurValues)
'    PSMOVCC_LLAVE(0) = LK_FECHA_DIA
'    PSMOVCC_LLAVE(1) = Format(cop_llave!cop_fecha_proceso, "yyyy")
'    PSMOVCC_LLAVE(2) = Format(cop_llave!cop_fecha_proceso, "mm")
'    PSMOVCC_LLAVE(3) = 1
'    PSMOVCC_LLAVE(4) = 1
'    movcc_llave.Requery
'End If
addcia = ""
If LISCIA.Visible Then
If LISCIA.Selected(4) Then
 LISCIA.ListIndex = 4
 PSPAR_MULTI(0) = Left(LISCIA.Text, 2)
 par_multi.Requery
 WEMPRESA = WEMPRESA + " -" & Trim(par_multi!par_nombre_corto)
...
End If
If opcompra(1).Value Then
  pub_cadena = "SELECT ALL_NUM_RECIBO,ALL_FECHA_ANT, ALL_FECHA_PRO ,ALL_IMPORTE_DOLL,ALL_NUMOPER,ALL_NUMOPER2,ALL_TIPMOV, ALL_MONEDA_CLI, ALL_NUMSER, ALL_NUMFAC, ALL_CP, ALL_IMPG2, ALL_IMPG1, ALL_CTAG2 , ALL_CTAG1, ALL_GASTOS, ALL_CODSUNAT, ALL_CODCLIE, ALL_FECHA_DIA, ALL_FECHA_SUNAT , ALL_IMPORTE_AMORT , ALL_IMPORTE ,ALL_BRUTO,ALL_IMPTO, ALL_NUMSER_C, ALL_NUMFAC_C, ALL_CODCIA, ALL_SECUENCIA  FROM ALLOG, CLIENTES WHERE (ALL_RUC = CLI_RUC_ESPOSO) AND (ALL_CP = CLI_CP) AND (ALL_CODCIA = CLI_CODCIA) AND (ALL_CODCIA in (?,?,?,?" & addcia & ")) AND (ALL_TIPMOV = ? OR ALL_TIPMOV = ?  OR  ALL_TIPMOV = ? OR  ALL_TIPMOV = ?) AND ALL_FECHA_PRO >= ? AND ALL_FECHA_PRO <= ? AND ALL_FLAG_EXT <> 'E' AND ALL_CP = 'P' AND CLI_CP = 'P' AND CLI_CODCLIE <> 0 "
  If Val(txt_cli.Text) <> 0 Then
     pub_cadena = pub_cadena + " AND CLI_RUC_ESPOSO = '" & LOC_RUC & "'"
  End If
End If
If opcompra(2).Value Then
  pub_cadena = "SELECT ALL_NUM_RECIBO, ALL_FECHA_ANT, ALL_IMPORTE_DOLL,ALL_NUMOPER,ALL_NUMOPER2,ALL_TIPMOV, ALL_MONEDA_CLI, ALL_NUMSER, ALL_NUMFAC, ALL_CP, ALL_IMPG2, ALL_IMPG1, ALL_CTAG2 , ALL_CTAG1, ALL_GASTOS, ALL_CODSUNAT, ALL_CODCLIE, ALL_FECHA_DIA, ALL_FECHA_SUNAT , ALL_IMPORTE_AMORT , ALL_IMPORTE ,ALL_BRUTO,ALL_IMPTO, ALL_NUMSER_C, ALL_NUMFAC_C, ALL_CODCIA, all_SECUENCIA FROM ALLOG, CLIENTES WHERE (ALL_RUC = CLI_RUC_ESPOSO) AND (ALL_CODCIA = CLI_CODCIA) AND (ALL_CODCIA in (?,?,?,? " & addcia & ")) AND (ALL_TIPMOV = ? OR ALL_TIPMOV = ?  OR  ALL_TIPMOV = ? OR  ALL_TIPMOV = ?) AND ALL_FECHA_PRO >= ? AND ALL_FECHA_PRO <= ? AND ALL_FLAG_EXT <> 'E' AND ALL_CP = 'P' AND CLI_CP = 'P' AND ALL_CODCLIE <> 0  "
  If Val(cta1.Text) <> 0 And Val(cta2.Text) <> 0 And Val(cta3.Text) <> 0 Then
     pub_cadena = pub_cadena + " AND (ALL_CTAG1 = '" & cta1.Text & "' OR ALL_CTAG1 = '" & cta2.Text & "' OR ALL_CTAG1 = '" & cta3.Text & "' OR  ALL_CTAG2 = '" & cta1.Text & "' OR ALL_CTAG2 = '" & cta2.Text & "' OR ALL_CTAG2 = '" & cta3.Text & "' )"
  ElseIf Val(cta1.Text) <> 0 And Val(cta2.Text) <> 0 Then
     pub_cadena = pub_cadena + " AND (ALL_CTAG1 = '" & cta1.Text & "' OR ALL_CTAG1 = '" & cta2.Text & "' OR  ALL_CTAG2 = '" & cta1.Text & "' OR ALL_CTAG2 = '" & cta2.Text & "' )"
...
If Trim(moneda.Text) <> "T" Then
  ...
  End If
End If
If Trim(filtro_tg) <> "" Then
   pub_cadena = pub_cadena + filtro_tg
End If
If Trim(filtro_cc) <> "" Then
  pub_cadena = pub_cadena + filtro_cc
End If
...
PS_REP01(6) = 0
PS_REP01(7) = 0
PS_REP01(8) = LK_FECHA_DIA
PS_REP01(9) = LK_FECHA_DIA
Set llave_rep01 = PS_REP01.OpenResultset(rdOpenKeyset, rdConcurReadOnly)
'Debug.Print pub_cadena
PS_REP01(2) = 0
If checompras.Value = 1 Then
...
If LISCIA.Selected(1) Then
 ...
 WEMPRESA = WEMPRESA + " -" & Trim(par_multi!par_nombre_corto)
End If
If LISCIA.Selected(2) Then
 LISCIA.ListIndex = 2
 PS_REP01(2) = Left(LISCIA.Text, 2)
 PSPAR_MULTI(0) = PS_REP01(2)
 par_multi.Requery
 WEMPRESA = WEMPRESA + " -" & Trim(par_multi!par_nombre_corto)
End If
If LISCIA.Selected(3) Then
 LISCIA.ListIndex = 3
 PS_REP01(3) = Left(LISCIA.Text, 2)
 PSPAR_MULTI(0) = PS_REP01(3)
 par_multi.Requery
 WEMPRESA = WEMPRESA + " -" & Trim(par_multi!par_nombre_corto)
End If
...
Do Until llave_rep01.EOF
  RCRYSTAL.ProgBar.Value = RCRYSTAL.ProgBar.Value + 1
  wnrocorr = wnrocorr + 1
  'If llave_rep01!ALL_NUMFAC = 41684 Then Stop
'  Print llave_rep01!ALL_NUMOPER2
'  If llave_rep01!ALL_TIPMOV = 13 Then Stop
'  If llave_rep01!ALL_FLAG_EXT = 13 Then Stop
...
'    Stop
  ...
  f1 = f1 + 1
  xl.Cells(f1, 1) = Val(wnrocorr)
  xl.Cells(f1, 2) = "'" & Format(llave_rep01!ALL_FECHA_SUNAT, "dd/mm/yy")
  If Val(llave_rep01!ALL_CODSUNAT) = 14 Then
    If llave_rep01!ALL_FECHA_SUNAT <> llave_rep01!all_fecha_ant Then
       xl.Cells(f1, 3) = "'" & Format(llave_rep01!all_fecha_ant, "dd/mm/yyyy") ' colocar manual la fec. vcto de pago
    Else
       xl.Cells(f1, 3) = "' " ' colocar manual la fec. vcto de pago
    End If
  Else
  xl.Cells(f1, 3) = "' " ' colocar manual la fec. vcto de pago
  End If
  xl.Cells(f1, 4) = "'" & Format(llave_rep01!ALL_CODSUNAT, "00")
  xl.Cells(f1, 5) = "'" & Format(llave_rep01!all_numser_c, "000")
  xl.Cells(f1, 6) = "'" & Format(llave_rep01!all_numfac_c, "0000000")
  If Val(llave_rep01!ALL_CODSUNAT) = 50 And Val(llave_rep01!ALL_NUM_RECIBO) <> 0 Then xl.Cells(f1, 7) = "'" & llave_rep01!ALL_NUM_RECIBO
 ' Print llave_rep01!ALL_FECHA_PRO
  ...
  xl.Cells(f1, 8) = "'06"
  End If
  xl.Cells(f1, 9) = Trim(cli_llave!cli_ruc_esposo)
  xl.Cells(f1, 10) = Trim(cli_llave!cli_nombre)
'  XL.Cells(f1, 7) = llave_rep01!ALL_MONEDA_CLI
'  If Val(llave_rep01!ALL_NUMFAC_C) = 2872 Then Stop
'XL.Application.Visible = True
  If llave_rep01!ALL_tipmov = 97 Then
    xl.Cells(f1, 11) = (redondea((Val(llave_rep01!ALL_IMPORTE_DOLL) * WTC)) - redondea(Val(llave_rep01!ALL_GASTOS) * WTC)) * wsigno
  Else
   If llave_rep01!ALL_GASTOS <> 0 Then
     xl.Cells(f1, 11) = (redondea((Val(llave_rep01!ALL_IMPORTE_AMORT) * WTC))) - redondea(Val(llave_rep01!ALL_GASTOS) * WTC)
   Else
     'xl.Cells(f1, 11) = (redondea((Val(llave_rep01!ALL_IMPORTE_AMORT) * WTC)) - redondea(Val(llave_rep01!ALL_GASTOS) * WTC)) * wsigno
     xl.Cells(f1, 11) = (redondea((Val(llave_rep01!ALL_BRUTO) * WTC)) - redondea(Val(llave_rep01!ALL_GASTOS) * WTC)) * wsigno
   End If
  End If
  
  xl.Cells(f1, 15) = redondea(Val(llave_rep01!ALL_GASTOS) * WTC) * wsigno
  'XL.Cells(f1, 10) = Trim(cli_llave!CLI_CUENTA_CONTAB)
  xl.Cells(f1, 12) = redondea(Val(llave_rep01!ALL_IMPTO) * WTC) * wsigno
  xl.Cells(f1, 17) = Val(xl.Cells(f1, 11)) + Val(xl.Cells(f1, 12)) + Val(xl.Cells(f1, 15))
  If WTC <> 1 Then xl.Cells(f1, 20) = WTC
  
  If llave_rep01!ALL_tipmov = 20 And llave_rep01!all_SECUENCIA <> 10 Then
'     XL.Cells(f1, 12) = redondea(Val(llave_rep01!ALL_BRUTO * WTC)) * wsigno
  Else
 '   XL.Cells(f1, 12) = 0
  End If
  If llave_rep01!ALL_tipmov = 97 Then
    pub_cadena = "SELECT  TOP 1 FAR_OC,FAR_PEDSER,FAR_PEDFAC,FAR_PORDESCTOS FROM FACART WHERE FAR_CODCIA = '" & llave_rep01!ALL_CODCIA & "' AND FAR_TIPMOV = 97 AND FAR_ESTADO <> 'E' AND FAR_FECHA = '" & Format(llave_rep01!ALL_FECHA_DIA, "dd/mm/yyyy") & "' AND FAR_NUMOPER = '" & llave_rep01!ALL_NUMOPER & "' AND FAR_PEDFAC <> 0 "
    Set X = CN.OpenResultset(pub_cadena, rdOpenKeyset, rdConcurValues) ' rdConcurReadOnly) ', rdConcurLock)
    If Not X.EOF Then
    xl.Cells(f1, 21) = "'" & Trim(X!far_PORDESCTOS)
    xl.Cells(f1, 22) = "'" & X!FAR_OC
    xl.Cells(f1, 23) = "'" & Nulo_Valor0(X!FAR_PEDSER)
    xl.Cells(f1, 24) = "'" & Nulo_Valor0(X!FAR_PEDFAC)
    End If
  End If
  ...
  If llave_rep01!ALL_tipmov = 20 And llave_rep01!all_SECUENCIA = 10 Then
    fca1 = "A"
    IMP_CTA1 = redondea(Val(llave_rep01!ALL_BRUTO * WTC)) * wsigno
    wCTAR = IMP_CTA1
    wCTARCTA = "608001"
  End If
  If llave_rep01!ALL_tipmov = 97 Or llave_rep01!ALL_tipmov = 98 Then
   If Trim(FILTRO_CTA(1)) <> "" Then
    If Trim(llave_rep01!ALL_CTAG1) = Trim(FILTRO_CTA(1)) Then
      wdescto = redondea(Val(llave_rep01!ALL_BRUTO * WTC)) * wsigno
      wDesctoCTA = llave_rep01!ALL_CTAG1 ' FILTRO_CTA(1)
      fca1 = "A"
     End If
   '    If Trim(llave_rep01!ALL_CTAG2) = Trim(FILTRO_CTA(1)) And IMP_CTA2 <> 0 Then
   '       wDescto = IMP_CTA2
  ...
  'CHE_IMPORTE = Val(XL.Cells(f1, 11)) + Val(XL.Cells(f1, 12)) + Val(XL.Cells(f1, 13)) + Val(XL.Cells(f1, 14)) + Val(XL.Cells(f1, 16))
  CHE_IMPORTE = Val(xl.Cells(f1, 11)) + Val(xl.Cells(f1, 12)) + Val(xl.Cells(f1, 15))
  If wCTAR2 <> 0 Then
    f1 = f1 + 1
    'XL.Cells(f1, 15) = wCTARCTA2
    'XL.Cells(f1, 16) = Val(wCTAR2)
    CHE_IMPORTE = CHE_IMPORTE + Val(xl.Cells(f1, 17))
    CHE_IMPORTE = (Val(xl.Cells(f1 - 1, 11)) + Val(xl.Cells(f1 - 1, 15))) - CHE_IMPORTE
    If WTC <> 1 And Val(xl.Cells(f1 - 1, 17)) <> 0 Then xl.Cells(f1 - 1, 17) = xl.Cells(f1 - 1, 17) + CHE_IMPORTE
    If Val(xl.Cells(f1 - 1, 17)) = 0 And Val(xl.Cells(f1 - 1, 15)) <> 0 Then xl.Cells(f1 - 1, 15) = xl.Cells(f1 - 1, 15) + (CHE_IMPORTE * -1)
    If WTC <> 1 And Val(xl.Cells(f1 - 1, 17)) <> 0 Then xl.Cells(f1 - 1, 17) = xl.Cells(f1 - 1, 17) + CHE_IMPORTE
    f1 = f1 - 1
  Else
    CHE_IMPORTE = Val(xl.Cells(f1, 11)) + Val(xl.Cells(f1, 15)) - CHE_IMPORTE
    If WTC <> 1 And Val(xl.Cells(f1, 17)) <> 0 Then xl.Cells(f1, 17) = xl.Cells(f1, 17) + CHE_IMPORTE
  End If
  
  xl.Cells(f1, 25) = "'" & llave_rep01!ALL_NUMSER & "-" & llave_rep01!all_numfac   ' NRO, INTERNO
  xl.Cells(f1, 26) = "'" & Format(llave_rep01!ALL_CODCIA, "00")
  If False Then
     ' PASE AL REGISTRO DE COMPRA
     ' ==========================
     
   movcc_fecha = Format(cop_llave!cop_fecha_proceso2, "dd/mm/yyyy")
   movcc_obra = llave_rep01!all_CC
   movcc_glosa = ""
   movcc_moneda = llave_rep01!ALL_MONEDA_CLI
   movcc_sunat = llave_rep01!ALL_CODSUNAT
   movcc_serie = llave_rep01!all_numser_c
   movcc_numfac = llave_rep01!all_numfac_c
   movcc_glosa = llave_rep01!ALL_NUMSER & " - " & llave_rep01!all_numfac
   movcc_fecha_emi = Format(llave_rep01!ALL_FECHA_SUNAT, "dd/mm/yyyy")
   movcc_fecha_vcto = Format(llave_rep01!ALL_FECHA_SUNAT, "dd/mm/yyyy")
   movcc_cc = ""
   movcc_fbg = llave_rep01!ALL_CODSUNAT
   movcc_tipo_gasto = Val(llave_rep01!ALL_DESCTO)
   '**************************
   
   If Val(xl.Cells(f1, 15)) <> 0 Then 'es afecto
     movcc_codcta = xl.Cells(f1, 15)
     movcc_dh = "D"
     movcc_importe = Format(xl.Cells(f1, 16), "0.00")
     movcc_imp_dol = 0
     WS_NRO_MOV = 0
     GoSub add_movicontcc
   Else
     movcc_codcta = "609001"
     movcc_dh = "D"
     movcc_importe = Format(xl.Cells(f1, 14), "0.00")
     WS_NRO_MOV = 0
     GoSub add_movicontcc
   End If
   'If Val(XL.Cells(F1, 11)) <> 0 Then 'es afecto
     movcc_codcta = "401001"
     movcc_dh = "D"
     movcc_importe = Format(xl.Cells(f1, 11), "0.00")
     WS_NRO_MOV = 1
     GoSub add_movicontcc
   'End If
     movcc_codcta = xl.Cells(f1, 10)
     movcc_dh = "H"
     movcc_importe = Val(Format(xl.Cells(f1, 8), "0.00")) + Val(Format(xl.Cells(f1, 9), "0.00"))
     WS_NRO_MOV = 2
     movcc_codclie = llave_rep01!ALL_CODCLIE
     movcc_cp = "P"
     GoSub add_movicontcc
...
Lfin = f1
  ...
  'XL.Cells(1, 1) = WEMPRESA '
  xl.Cells(2, 1) = "'PERIODO: " & UCase(Format(wsFECHA1, "MMMM-yyyy"))
  xl.Cells(3, 1) = "'RUC: " & Trim(par_llave!par_ruc_emp)
  xl.Cells(4, 1) = "'" & Trim(par_llave!par_nombre)
  'pub_mensaje = "Desea mostrar el Resumen de Asiento Contable... ?"
  'Pub_Respuesta = MsgBox(pub_mensaje, Pub_Estilo, Pub_Titulo)
 ' If Pub_Respuesta = vbYes Then
 '   GoSub PASAR_CONT
...
WEXCEL:
  ...
  End If
  DoEvents
  xl.Workbooks.Open PUB_RUTA_OTRO & "RCOMPRANORMA.xls", 0, True, 4, "", ""
Return
...
For fila = Lini To Lfin
  If Trim(xl.Cells(fila, 5)) = "" And Trim(xl.Cells(fila, 15)) = "" Then GoTo cont_p1
'  If Trim(Format(XL.Cells(fila, 15), "##########")) = "601001" Then Stop
'  XL.Application.Visible = True
  If Trim(ts_codcta) <> Trim(Format(xl.Cells(fila, 15), "##########")) Then
    xl.Sheets(2).Activate
    f1 = f1 + 1
...
'    PSMOVCC_LLAVE(4) = 1
   ...
   movcc_llave!MOV_CODCIA = LK_CODCIA
   movcc_llave!MOV_PERIODO = Format(cop_llave!cop_fecha_proceso, "yyyy")
   movcc_llave!MOV_nro_MES = Format(cop_llave!cop_fecha_proceso, "mm")
   movcc_llave!MOV_NRO_VOUCHER = ws_nro_voucher
   movcc_llave!MOV_NRO_MOV = WS_NRO_MOV
   movcc_llave!MOV_TIPMOV = 1
   movcc_llave!MOV_TIPDOC = 1
   movcc_llave!MOV_FECHA = movcc_fecha
   movcc_llave!MOV_GLOSA = movcc_glosa
   movcc_llave!MOV_MONEDA = movcc_moneda
   movcc_llave!mov_codcta = movcc_codcta
   movcc_llave!MOV_DH = movcc_dh
   movcc_llave!MOV_IMPORTE = Val(movcc_importe)
   movcc_llave!MOV_SUNAT = Format(movcc_sunat, "00")
   movcc_llave!MOV_serie = movcc_serie
   movcc_llave!MOV_numfac = movcc_numfac
   movcc_llave!MOV_codclie = Val(movcc_codclie)
   movcc_llave!MOV_CP = movcc_cp
  
   movcc_llave!MOV_FBG = Format(movcc_fbg, "00")
   movcc_llave!MOV_MARCA = "X"
   movcc_llave!MOV_DETALLE = movcc_glosa
   movcc_llave!MOV_FBG_C = Format(movcc_fbg, "00")
   movcc_llave!MOV_SERIE_C = movcc_serie
   movcc_llave!MOV_NUMFAC_C = movcc_numfac
   movcc_llave!MOV_fecha_EMI = movcc_fecha_emi
   movcc_llave!MOV_fecha_vcto = movcc_fecha_vcto
   movcc_llave!MOV_PLANTILLA = 1
   movcc_llave!MOV_FLAG_TC = ""
   movcc_llave!MOV_TIPO_CAMBIO = 0 ' Val(FORM_CONTA2.grid_fac.TextMatrix(fila, 12))
   movcc_llave!MOV_FLAG_DES = " "
   movcc_llave!MOV_CODUSU = LK_CODUSU
   movcc_llave!MOV_CC = movcc_cc
   movcc_llave!MOV_OPC = movcc_obra
   movcc_llave!MOV_exonerado = 0
   
   movcc_llave!MOV_RUC = ""
   
   movcc_llave!MOV_CODZON = ""
   movcc_llave!MOV_IMP_DOL = Val(movcc_imp_dol)
   movcc_llave!MOV_FILE = 1
   movcc_llave!MOV_TIPO_GASTO = Val(movcc_tipo_gasto)
...
Dim WCIA3 As String * 2
Dim WCIA4 As String * 2
Dim WCIA5 As String * 2
Dim WCIA6 As String * 2
Dim WCIA7 As String * 2
Dim WSCODART As Currency
Dim FF1 As Integer
...
End If
If LISCIA.ListCount >= 0 And LISCIA.Visible Then
WCIA1 = ""
WCIA2 = ""
WCIA3 = ""
WCIA4 = ""
...
If LISCIA.Selected(fila) Then
    If Trim(WCIA1) = "" Then
     WCIA1 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA2) = "" Then
     WCIA2 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA3) = "" Then
     WCIA3 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA4) = "" Then
     WCIA4 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA5) = "" Then
     WCIA5 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA6) = "" Then
     WCIA6 = Left(LISCIA.List(fila), 2)
    ElseIf Trim(WCIA7) = "" Then
     WCIA7 = Left(LISCIA.List(fila), 2)
    End If
End If
Next fila

If Trim(WCIA1) = "" And Trim(WCIA2) = "" And Trim(WCIA3) = "" And Trim(WCIA4) = "" And Trim(WCIA5) = "" And Trim(WCIA6) = "" And Trim(WCIA7) = "" Then
  For fila = 0 To LISCIA.ListCount - 1
    LISCIA.ListIndex = fila
    If fila = 0 Then
       WCIA1 = Left(LISCIA.Text, 2)
    ...
    End If
    If fila = 4 Then
       WCIA5 = Left(LISCIA.Text, 2)
    End If
    If fila = 5 Then
       WCIA6 = Left(LISCIA.Text, 2)
    End If
    If fila = 6 Then
       WCIA7 = Left(LISCIA.Text, 2)
    End If
  Next fila
End If
OTRO:
...
pub_cadena = "SELECT * FROM ALLOG WHERE (ALL_CODCIA = ? OR ALL_CODCIA = ? OR ALL_CODCIA = ? OR ALL_CODCIA = ? OR ALL_CODCIA = ? OR ALL_CODCIA = ? OR ALL_CODCIA = ?)  AND (ALL_CODBAN = ?) AND (ALL_FECHA_SUNAT >= ? AND ALL_FECHA_SUNAT <= ? ) AND all_codban <> 0 and all_codtra <> 2401  and all_codtra <> 2725 AND all_signo_ccm  <> 0 AND ALL_FLAG_EXT <> 'E'  ORDER BY ALL_FECHA_CAN, ALL_SIGNO_CCM DESC,ALL_CHENUM"
Set PS_REP02 = CN.CreateQuery("", pub_cadena)
PS_REP02(0) = 0
PS_REP02(1) = 0
PS_REP02(2) = 0
...
PS_REP02(6) = 0
PS_REP02(7) = 0
PS_REP02(8) = LK_FECHA_DIA
PS_REP02(9) = LK_FECHA_DIA
Set llave_rep02 = PS_REP02.OpenResultset(rdOpenKeyset, rdConcurReadOnly)
PS_REP02(0) = WCIA1
PS_REP02(1) = WCIA2
PS_REP02(2) = WCIA3
     ...
     If llave_rep02!ALL_moneda_ccm = "D" Then
         If cheflag.Value = 1 Then
           ...
           ElseIf llave_rep02!ALL_CODTRA = 5318 Then
             If llave_rep02!ALL_CODTRA = 5318 And ccm_llave!CCM_MONEDA = "D" Then
                 W_IMPORTE = redondea(Val(llave_rep02!ALL_IMPORTE_AMORT))
             Else
           ...
           ElseIf llave_rep02!ALL_CODTRA = 2720 Then
            ...
            If llave_rep02!ALL_TIPDOC = "LE" Then
                SQ_OPER = 4
                pu_codcia = llave_rep02!ALL_CODCIA
                PU_FBG = llave_rep02!ALL_FBG
                PUB_TIPDOC = llave_rep02!ALL_TIPDOC
                PUB_NUMSER = llave_rep02!all_numser_c
                PUB_NUMFAC = llave_rep02!all_numfac_c
                LEER_CAR_LLAVE
                car_far.MoveLast
                If Not car_far.EOF Then
                    W_IMPORTE = redondea(Val(llave_rep02!ALL_IMPORTE) * JALAR_TC(car_far!car_fecha_sunat, 3))
                End If
            Else
              PU_TIPMOV = 10
              pu_codcia = llave_rep02!ALL_CODCIA
           ...
           ElseIf llave_rep02!ALL_CODTRA = 2735 Then
              ...
              Else
                 ...
                 If Not llave_rep01.EOF Then
                    ...
                    ElseIf llave_rep02!ALL_TIPDOC = "PP" Then
                       W_IMPORTE = redondea(Val(llave_rep02!ALL_IMPORTE) * JALAR_TC(llave_rep01!ALL_FECHA_SUNAT, -1))
           ...
           End If
         Else
           If llave_rep02!ALL_CODTRA = 5318 And ccm_llave!CCM_MONEDA = "S" Then
