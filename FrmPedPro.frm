...
If Not relcomp_llave.EOF Then
 pub_mensaje = "Reemplazar la infomaci�n...   �Desea Continuar... ?"
...
If PUB_KEY <> 0 Then
    ...
    If Val(art_LLAVE!art_numero) = 3 Then
           MsgBox "Producto en Proceso de Liquidaci�n ", 48, Pub_Titulo
     Exit Sub
    End If
...
grdidet.TextMatrix(0, 3) = "Descripci�n"
...
GRID_MST.TextMatrix(0, 2) = "Descripci�n"
