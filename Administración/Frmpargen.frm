...
Begin VB.Form FrmParGen 
   Caption         =   "Definici�n de Compa�ia"
   ClientHeight    =   5310
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8325
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fracambio 
         Caption         =   "Actualizaci�n de precios de productos en Dolares .:"
         Height          =   3255
         Left            =   -74880
         TabIndex        =   51
         Top             =   480
         ...
         Begin VB.CommandButton Command1 
            Caption         =   "Procesar la Actualizaci�n de Precios"
            Height          =   495
            Left            =   480
            TabIndex        =   53
            Top             =   1680
      ...
      Begin VB.CheckBox chepuntos 
         Caption         =   "Compa�ia como Punto de Ventas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame F2 
         ...
         Begin VB.OptionButton flagfac 
            Caption         =   "Facturaci�n (Talonario) por Compa�ia"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         End
         Begin VB.OptionButton flagfac 
            Caption         =   "Facturaci�n (Talonario) por Vendedores"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.CheckBox cheigv 
            Caption         =   "Facturaci�m - I.G.V.  Incluido"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
         ...
         Begin VB.Label Label2 
            AutoSize        =   -1  'True
            Caption         =   "La definic�n de los documentos est� configurada por vendedor."
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      End
      Begin VB.Label Label2 
         Caption         =   "Compa�as con la que relaciona."
         Height          =   255
         Index           =   1
         Left            =   -68400
         TabIndex        =   40
      ...
      End
      Begin VB.Label Label2 
         Caption         =   "(%) de Comisi�n y rango de Dias."
         Height          =   435
         Index           =   0
         Left            =   -68520
         TabIndex        =   34
...
Else
   ...
   If Not parloc_llave.EOF Then
     MsgBox "La Compa�ia EXISTE en el Sistema Carge El Formulario Nuevamente.", 48, Pub_Titulo
     Unload FrmParGen
     Exit Sub
   End If
   ...
   MsgBox "Se Agrego una Nueva Compa�ia , Debe dar derechos a los usuarios y Reiniciar el Sistema.", 48, Pub_Titulo
   Unload FrmParGen
   Exit Sub
End If
...
End If
  ...
  If Pub_Respuesta = vbYes Then   ' El usuario eligi�
    ...
    MsgBox "Compa�ia Eliminada , se procede a salir de Sistema, vuelva a ingresar y cambie de compa�ia", 48, ws_titulo
    ' salir
    Screen.MousePointer = 11
    DoEvents
...
Else
    ...
    End If
     ...
     cheigv.Enabled = False
     Screen.MousePointer = 0
     MsgBox "Datos de la Compa�ia ha cambiado, se Reinicia a Cia:  " & (txtnombre.text) & ".", 48, Pub_Titulo
...
If parloc_llave.EOF Then
  Azul Txt_key, Txt_key
  MsgBox "Compa�ia NO EXSITE en PARGEN, consulte al Administrador, Procede a Salir de Sistema", 48, Pub_Titulo
  Screen.MousePointer = 11
  DoEvents
  MDIForm1.WindowState = 1
  MDIForm1.Caption = ""
