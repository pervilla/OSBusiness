...
Begin VB.Form FrmSub 
   Caption         =   "Configuraci�n de Transacciones"
   ClientHeight    =   6660
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9510
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      _Version        =   393216
      TabHeight       =   520
      TabCaption(0)   =   "&Definici�n de Transacci�n"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CheckBox chetransa 
            Caption         =   "Incluir Nueva Transaci�n"
            Enabled         =   0   'False
            Height          =   375
            Left            =   120
            TabIndex        =   27
      ...
      Begin VB.Label Label3 
         Caption         =   "Relaci�n con Tipo de Descto."
         ForeColor       =   &H00000080&
         Height          =   255
         Left            =   8475
         TabIndex        =   138
...
Grid1.TextMatrix(fila, 3) = "Descripci�n"
Grid1.Rows = 2
Grid1.Cols = 4
...
If chetransa.Value = 1 Then
    Mensaje = "Introduzca la Nueva Transacci�n , debe ser numerico de 4 Digitos : "
    T�tulo = "Definici�n de Transacci�n "
    valorpred = " "
...
Else
    ...
    msg = "Ingrese la "
End If
 Mensaje = msg & "Secuencia para la Transacci�n , debe ser numerico  : "
 T�tulo = "Copia - Definici�n de Transacci�n "
 valorpred = " "
 mivalor = InputBox(Mensaje, T�tulo, valorpred)
 If mivalor = "" Then
    Exit Sub
...
Next
 ...
 If Not SUT_LLAVE.EOF Then
    Screen.MousePointer = 0
    MsgBox "Secuencia de Transacci�n ya EXISTE... Reintente la copia !!!", 48, Pub_Titulo
...
Screen.MousePointer = 0
MsgBox "Copia Efectuada . Transacci�n  : " & PUB_CODTRA & "  Secuencia :" & mivalor, 48, Pub_Titulo
cmdcancelar_Click
otro_llave.Close
Exit Sub
End Sub
...
Case 0
   ...
   If KeyAscii = 13 Then
        ...
        If PUB_CODTRA <> -1 Then
         ...
         Grid1.SetFocus
        Else
         MsgBox "No existe Transacci�n...", 48, Pub_Titulo
         PUB_CODTRA = 0
