...
" From   { oj (((((((" & CONST_DATABASE & ".dbo.ARTI ARTI INNER JOIN " & CONST_DATABASE & ".dbo.PRECIOS PRECIOS ON  ARTI.ART_CODCIA = PRECIOS.PRE_CODCIA AND  ARTI.ART_KEY = PRECIOS.PRE_CODART) " & _
"  INNER JOIN " & CONST_DATABASE & ".dbo.TABLAS TABLAS ON " & _
"        ARTI.ART_CODCIA = TABLAS.TAB_CODCIA AND " & _
"    ARTI.ART_FAMILIA = TABLAS.TAB_NUMTAB) " & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO ARTICULO ON ARTI.ART_KEY = ARTICULO.ARM_CODART AND  ARTI.ART_CODCIA = ARTICULO.ARM_CODCIA)" & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO stock03 ON  ARTICULO.ARM_CODART = stock03.ARM_CODART)  " & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO stock08 ON  ARTICULO.ARM_CODART = stock08.ARM_CODART)  " & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO SUBALMACEN ON  stock03.ARM_CODART = SUBALMACEN.ARM_CODART) " & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO ALMA07 ON  SUBALMACEN.ARM_CODART = ALMA07.ARM_CODART) " & _
"     INNER JOIN " & CONST_DATABASE & ".dbo.ARTICULO DILVISAALMACEN ON SUBALMACEN.ARM_CODART = DILVISAALMACEN.ARM_CODART} " & _
